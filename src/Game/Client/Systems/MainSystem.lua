...
function MainSystem:load()
	...
	self.sceneManagerSystem = self.create(script.Parent.SceneManagerSystem, self.eventManager, self.entityManager, self.componentManager, self.world, self.camera, self.screenGui)
