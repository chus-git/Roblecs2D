...
function MainSystem:init()
    ...
    self:addComponent(self.boy, RectColliderComponent(1, 1))
    ...
    self:addComponent(self.girl, RectColliderComponent(1, 1))
    ...
    self:addComponent(self.girl2, RectColliderComponent(1, 1))
    ...
    self:addComponent(self.girl3, RectColliderComponent(1, 1))
    ...
    self:addComponent(self.girl4, RectColliderComponent(1, 1))
